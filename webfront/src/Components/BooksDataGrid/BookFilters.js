...
const BookFilters = ( props ) => {
    ...
    return (
        <Box>
            <Grid container>
                <Grid className={ styles.inputFieldGrid } xs={ 3 } item={ true }>
                    <TextField className={ styles.inputField } name={ "author" }
                               label={ <FormattedMessage id="filters.author"/> } variant={ "standard" }
                               onChange={ onAuthorFilterChanged }/>
                </Grid>
                <Grid className={ styles.inputFieldGrid } xs={ 3 } item={ true }>
                    <TextField className={ styles.inputField } name={ "title" }
                               label={ <FormattedMessage id="filters.title"/> } variant={ "standard" }
                               onChange={ onTitleFilterChanged }/>
                </Grid>
                <Grid className={ styles.inputFieldGrid } xs={ 3 } item={ true }>
                    <TextField className={ styles.inputField } name={ "release" }
                               label={ <FormattedMessage id="filters.release"/> } variant={ "standard" }
                               onChange={ onReleaseFilterChanged }/>
                </Grid>
                <Grid className={ styles.inputFieldGrid } xs={ 3 } item={ true }>
                    <TextField className={ styles.inputField } name={ "signature" }
                               label={ <FormattedMessage id="filters.signature"/> } variant={ "standard" }
